...
case_dispatchhistory = CDEJobRunOperator(
    task_id=f"{case_dispatchhistory}",
    job_name=f"{case_dispatchhistory}",
    dag=dag,
)

planbranch_planconstraint = CDEJobRunOperator(
    task_id=f"{planbranchnrsl_planbranchnrss_planconstraintnrsl_planconstraintnrss_planconstraintrtd}",
    job_name=f"{planbranchnrsl_planbranchnrss_planconstraintnrsl_planconstraintnrss_planconstraintrtd}",
    dag=dag,
)

branch_constraint_constraintbranch = CDEJobRunOperator(
    task_id=f"{branch_constraint_constraintbranch}",
    job_name=f"{branch_constraint_constraintbranch}",
    dag=dag,
)

analog_cct = CDEJobRunOperator(
    task_id=f"{analogcct}",
    job_name=f"{analogcct}",
    dag=dag,
)

contingencyviol = CDEJobRunOperator(
    task_id=f"{contingencyviol}",
    job_name=f"{contingencyviol}",
    dag=dag,
)
